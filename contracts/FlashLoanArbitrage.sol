...
contract FlashLoanArbitrage is FlashLoanSimpleReceiverBase {
    ...
    // AAVE ERC20 Token addresses 'Goerli'
    // Other addresses are available at: https://docs.aave.com/developers/deployed-contracts/v3-testnet-addresses
    address private immutable daiAddress =
        0xDF1742fE5b0bFc12331D8EAec6b478DfDbD31464;
    address private immutable usdcAddress =
        0xA2025B15a1757311bfD68cb14eaeFCc237AF5b43;

    // Ensure that you deploy the DEX contract and then paste the deployed contracts address, otherwise your flash loan will be unable to communicate.    
    address private dexContractAddress =
        0xbBEcc32D326296A6FB70d50B21A6f2DFD9458187;
    ...
    // Once the flash loan is accepted then the following will be executed.
    function executeOperation(
        ...
        //The loan is now due to be paid back to AAVE
